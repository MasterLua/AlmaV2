...
local items = {
    [1] = {name = "Hi-Fi", timeToTake = Astra.second(2), resellerPrice = 650, prop = "as_prop_as_speakerdock", itr = 1.0},
    [2] = {name = "Lampe", timeToTake = Astra.second(5), resellerPrice = 500, prop = "apa_mp_h_floorlamp_a", additionalZ = 1.50, itr = 1.0},
    [3] = {name = "Lampe", timeToTake = Astra.second(5), resellerPrice = 500, prop = "apa_mp_h_lit_floorlampnight_14", additionalZ = 1.50, itr = 1.0},
    [4] = {name = "Plante rare", timeToTake = Astra.second(4), resellerPrice = 1000, prop = "apa_mp_h_acc_vase_flowers_01", additionalZ = 1.0, itr = 1.0},
    [5] = {name = "Appareil photo", timeToTake = Astra.second(2), resellerPrice = 1000, prop = "prop_pap_camera_01", itr = 1.0},
    [6] = {name = "Pack d'argent", timeToTake = Astra.second(1), resellerPrice = 2000, prop = "bkr_prop_moneypack_01a", itr = 1.0},
    [7] = {name = "Bijoux rare", timeToTake = Astra.second(2), resellerPrice = 3000, prop = "p_jewel_necklace01_s", itr = 1.0},
    [8] = {name = "Caisse d'argent", timeToTake = Astra.second(30), resellerPrice = 5000, prop = "ex_prop_crate_money_bc", itr = 4.0}
}
