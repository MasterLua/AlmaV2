...
function RageUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.Sprite = { Color = { R = settings.color[1], G = settings.color[2], B = settings.color[3], A = 100 } }
    Menu.Rectangle = { R = settings.color[1], G = settings.color[2], B = settings.color[3], A = 100 }
...
---@public
---@return void
function RageUI.Menus:SetInventorySize(Size)
	self.PageCounter = string.format("%s kg", Size)
end
