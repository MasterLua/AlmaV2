...
Alma:AddEventHandler("Staff", "ModifySpeed", function(realId, modify)
    ...
    local pVeh = GetVehiclePedIsUsing(pPed)
    print(pPed, pVeh)
    SetDriveTaskCruiseSpeed(pVeh, modify+1.0)
    ModifyVehicleTopSpeed(pVeh, modify+1.0)
    SetVehicleLodMultiplier(pVeh, modify/10+1.0)
    SetVehicleCheatPowerIncrease(pVeh, modify+1.0)
    SetVehicleBoostActive(pVeh, true)
    SetVehicleRocketBoostActive(pVeh, true)
    SetVehicleRocketBoostPercentage(pVeh, modify+1.0)
end)
