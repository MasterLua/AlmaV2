Locales['fr'] = {
  ...
  ['gave_item'] = 'vous avez donné ~r~%sx~s~ ~b~%s~s~ à ~r~%s~s~',
  ['received_item'] = 'vous avez reçu ~r~%sx~s~ ~b~%s~s~ par ~b~%s~s~',
  ['gave_weapon'] = 'vous avez donné ~r~1x~s~ ~b~%s~s~ à ~r~%s~s~',
  ['gave_weapon_ammo'] = 'vous avez donné ~o~%sx %s~s~ pour ~b~%s~s~ à ~r~%s~s~',
  ['gave_weapon_withammo'] = 'vous avez donné ~r~1x~s~ ~b~%s~s~ avec ~o~%sx %s~s~ à ~r~%s~s~',
  ['gave_weapon_hasalready'] = '~r~%s~s~ a déjà ~r~%s~s~',
  ['gave_weapon_noweapon'] = '~r~%s~s~ n\'a pas cette arme',
  ['received_weapon'] = 'vous recevez ~r~1x~s~ ~b~%s~s~ de ~b~%s~s~',
  ['received_weapon_ammo'] = 'vous avez reçu ~o~%sx %s~s~ pour votre ~b~%s~s~ de ~b~%s~s~',
  ['received_weapon_withammo'] = 'vous avez reçu ~r~1x~s~ ~b~%s~s~ avec ~o~%sx %s~s~ de ~b~%s~s~',
  ['received_weapon_hasalready'] = '~b~%s~s~ a tenté de vous donner ~r~%s~s~, mais vous en aviez déjà un exemplaire',
  ['received_weapon_noweapon'] = '~b~%s~s~ tente de vous donner des munitions pour ~r~%s~s~, mais vous n\'en avez pas',
  ['gave_account_money'] = 'vous avez donné ~g~$%s~s~ (%s) à ~r~%s~s~',
  ...
  ['threw_standard'] = 'vous avez jeté ~r~%sx~s~ ~b~%s~s~',
  ['threw_account'] = 'vous avez jeté ~g~$%s~s~ ~b~%s~s~',
  ['threw_weapon'] = 'vous avez jeté ~r~1x~s~ ~b~%s~s~',
  ['threw_weapon_ammo'] = 'vous avez jeté ~r~1x~s~ ~b~%s~s~ avec ~o~%sx %s~s~',
