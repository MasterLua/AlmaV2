...
RegisterServerEvent('Helper:showAdvancedNotification_chat:messageEntered')
AddEventHandler('Helper:showAdvancedNotification_chat:messageEntered', function(author, color, message)
	local _source = source
