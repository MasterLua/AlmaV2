...
WeaponsOnly = {
	...
	{name = 'WEAPON_CERAMICPISTOL', label = _U('weapon_ceramicpistol'), tints = DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = 'AMMO_PISTOL'}},
	{
	...
	{name = 'WEAPON_DOUBLEACTION', label = _U('weapon_doubleaction'), tints = DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = 'AMMO_PISTOL'}},
	{name = 'WEAPON_NAVYREVOLVER', label = _U('weapon_navyrevolver'), tints = DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = 'AMMO_PISTOL'}},
	{name = 'WEAPON_FLAREGUN', label = _U('weapon_flaregun'), tints = DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_flaregun'), hash = 'AMMO_FLAREGUN'}},
	{name = 'WEAPON_GADGETPISTOL', label = _U('weapon_gadgetpistol'), tints = DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = 'AMMO_PISTOL'}},
	{
	...
	{name = 'WEAPON_MARKSMANPISTOL', label = _U('weapon_marksmanpistol'), tints = DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = 'AMMO_PISTOL'}},
	{
		name = 'WEAPON_PISTOL',
	...
	{name = 'WEAPON_STUNGUN', label = _U('weapon_stungun'), tints = DefaultWeaponTints, components = {}},
	{name = 'WEAPON_RAYPISTOL', label = _U('weapon_raypistol'), tints = DefaultWeaponTints, components = {}},
	{
	...
	{name = 'WEAPON_AUTOSHOTGUN', label = _U('weapon_autoshotgun'), tints = DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_shells'), hash = 'AMMO_SHOTGUN'}},
	{
	...
	{name = 'WEAPON_DBSHOTGUN', label = _U('weapon_dbshotgun'), tints = DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_shells'), hash = 'AMMO_SHOTGUN'}},
	{
	...
	{name = 'WEAPON_MUSKET', label = _U('weapon_musket'), tints = DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = 'AMMO_SHOTGUN'}},
	{
	...
	{name = 'WEAPON_RAYCARBINE', label = _U('weapon_raycarbine'), ammo = {label = _U('ammo_rounds'), hash = 'AMMO_SMG'}, tints = DefaultWeaponTints, components = {}},
	-- Rifles
	{
	...
	-- Heavy / Launchers
	{name = 'WEAPON_COMPACTLAUNCHER', label = _U('weapon_compactlauncher'), tints = DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_grenadelauncher'), hash = 'AMMO_GRENADELAUNCHER'}},
	{name = 'WEAPON_FIREWORK', label = _U('weapon_firework'), components = {}, ammo = {label = _U('ammo_firework'), hash = 'AMMO_FIREWORK'}},
	{name = 'WEAPON_GRENADELAUNCHER', label = _U('weapon_grenadelauncher'), tints = DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_grenadelauncher'), hash = 'AMMO_GRENADELAUNCHER'}},
	{name = 'WEAPON_HOMINGLAUNCHER', label = _U('weapon_hominglauncher'), tints = DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rockets'), hash = 'AMMO_HOMINGLAUNCHER'}},
	{name = 'WEAPON_MINIGUN', label = _U('weapon_minigun'), tints = DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = 'AMMO_MINIGUN'}},
	{name = 'WEAPON_RAILGUN', label = _U('weapon_railgun'), tints = DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = 'AMMO_RAILGUN'}},
	{name = 'WEAPON_RPG', label = _U('weapon_rpg'), tints = DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rockets'), hash = 'AMMO_RPG'}},
	{name = 'WEAPON_RAYMINIGUN', label = _U('weapon_rayminigun'), tints = DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = 'AMMO_MINIGUN'}},
	-- Thrown
...
function ESX.IsContribWeapon(weaponName)
    weaponName = string.upper(weaponName)

    if ContribWeapons[weaponName] then
        return true
    end
...
ESX.GetWeaponLabel = function(weaponName)
	...
	for k,v in pairs(WeaponsOnly) do
		if v.name == weaponName then
			return v.label
		end
	end
